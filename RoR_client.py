...
class eventHandler:
    ...
    def on_chat(self, source, message):
        ...
        # End roleplay commands
            ...
            self.__sendChat_delayed("Available commands: -version, -countdown, -countdown2, -brb, -afk, -back, -gtg, -police, -ems, -fire, -rip, -kickme, -getpos, -roll, !version, !rules, !motd, !vehiclelimit, !boost, !boost2, !boost3, !boost4")
